...
export function getBlockchainConfig() {
    ...
    return {
        ...
        // Contract Addresses
        contracts: {
            storyNftContract: process.env.STORY_NFT_CONTRACT_ADDRESS || undefined,
            ipAssetRegistry: process.env.STORY_PROTOCOL_IP_ASSET_REGISTRY || undefined,
            licensingModule: process.env.STORY_PROTOCOL_LICENSING_MODULE || undefined,
            royaltyModule: process.env.STORY_PROTOCOL_ROYALTY_MODULE || undefined,
            disputeModule: process.env.STORY_PROTOCOL_DISPUTE_MODULE || undefined,
        },
 ...
 */
export function getStoryProtocolConfig() {
 ...
 */
export function calculateGasWithBuffer(estimatedGas, bufferPercentage = 20) {
 ...
 */
export function logBlockchainOperation(operation, details, config) {
...
export function logGasUsage(operation, gasUsed, gasPrice, config) {
    if (!config.enableGasReporting)
        return;

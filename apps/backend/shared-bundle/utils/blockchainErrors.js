...
(function (BlockchainErrorType) {
    // Network Errors
    BlockchainErrorType["RPC_ERROR"] = "RPC_ERROR";
    BlockchainErrorType["NETWORK_TIMEOUT"] = "NETWORK_TIMEOUT";
    BlockchainErrorType["NETWORK_UNAVAILABLE"] = "NETWORK_UNAVAILABLE";
    // Transaction Errors
    BlockchainErrorType["INSUFFICIENT_FUNDS"] = "INSUFFICIENT_FUNDS";
    BlockchainErrorType["GAS_LIMIT_EXCEEDED"] = "GAS_LIMIT_EXCEEDED";
    BlockchainErrorType["TRANSACTION_REVERTED"] = "TRANSACTION_REVERTED";
    BlockchainErrorType["NONCE_TOO_LOW"] = "NONCE_TOO_LOW";
    BlockchainErrorType["REPLACEMENT_UNDERPRICED"] = "REPLACEMENT_UNDERPRICED";
    // Contract Errors
    BlockchainErrorType["CONTRACT_NOT_DEPLOYED"] = "CONTRACT_NOT_DEPLOYED";
    BlockchainErrorType["CONTRACT_CALL_FAILED"] = "CONTRACT_CALL_FAILED";
    BlockchainErrorType["INVALID_CONTRACT_ADDRESS"] = "INVALID_CONTRACT_ADDRESS";
    // IP Asset Specific Errors
    BlockchainErrorType["IP_ASSET_ALREADY_REGISTERED"] = "IP_ASSET_ALREADY_REGISTERED";
    BlockchainErrorType["UNAUTHORIZED_IP_OPERATION"] = "UNAUTHORIZED_IP_OPERATION";
    BlockchainErrorType["LICENSE_ALREADY_EXISTS"] = "LICENSE_ALREADY_EXISTS";
    BlockchainErrorType["INVALID_LICENSE_TERMS"] = "INVALID_LICENSE_TERMS";
    // Wallet/Account Errors
    BlockchainErrorType["WALLET_NOT_CONNECTED"] = "WALLET_NOT_CONNECTED";
    BlockchainErrorType["INVALID_PRIVATE_KEY"] = "INVALID_PRIVATE_KEY";
    BlockchainErrorType["INSUFFICIENT_PERMISSIONS"] = "INSUFFICIENT_PERMISSIONS";
    // Configuration Errors
    BlockchainErrorType["INVALID_CHAIN_ID"] = "INVALID_CHAIN_ID";
    BlockchainErrorType["SDK_NOT_INITIALIZED"] = "SDK_NOT_INITIALIZED";
    BlockchainErrorType["MISSING_ENVIRONMENT_VARIABLES"] = "MISSING_ENVIRONMENT_VARIABLES";
    // Unknown Errors
 ...
 */
export function calculateRetryDelay(attempt, baseDelay, backoffMultiplier) {
 ...
 */
export function isGasError(errorType) {
    return [
 ...
 */
export function isNetworkError(errorType) {
    return [
...
//# sourceMappingURL=blockchainErrors.js.map
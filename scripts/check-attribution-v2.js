...
// HybridRevenueControllerV2 ABI (updated for V2)
const ABI = [
  ...
  "function books(bytes32 bookId) view returns (address curator, uint256 totalChapters, bool isActive, string ipfsMetadataHash)"
];
...
if (args.length < 2) {
  console.log('Usage: node check-attribution-v2.js <bookId> <chapterNumber>');
  console.log('Example: node check-attribution-v2.js "0x3873c0d1bcfa245773b13b694a49dac5b3f03ca2/project-phoenix" 1');
  process.exit(1);
}
